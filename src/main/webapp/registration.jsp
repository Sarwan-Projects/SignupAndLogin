...
<body>
	...
	<script type="text/javascript">
		...
		if(status=="InavalidName")
		{
			swal("Congrats","Please Enter a Name","error");
		}
		if(status=="InavalidEmail")
		{
			swal("Congrats","Please Enter Email","error");
		}
		if(status=="InavalidUpwd")
		{
			swal("Congrats","Please Enter Password","error");
		}
		if(status=="InavalidConfirm")
		{
			swal("Congrats","Password Does Not Match","error");
		}
		if(status=="InavalidMobile")
		{
			swal("Congrats","Please Enter Mobile Number","error");
		}
		if(status=="InavalidLength")
		{
			swal("Congrats","Mobile Number Should Be of 10 Digits","error");
		}
	</script>
